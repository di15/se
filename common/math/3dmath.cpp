...
#ifdef MATH_DEBUG
	g_applog<<"intersection denom="<<denom<<" (plane=n("<<p.m_normal.x<<","<<p.m_normal.y<<","<<p.m_normal.z<<")d="<<p.m_d<<") (line=("<<l.x<<","<<l.y<<","<<l.z<<"))"<<std::endl;
	g_applog.flush();
#endif
...
#ifdef MATH_DEBUG
	g_applog<<"intersection pointonplane="<<p0.x<<","<<p0.y<<","<<p0.z<<std::endl;
	g_applog.flush();
#endif
