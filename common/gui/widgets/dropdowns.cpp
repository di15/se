...
void DropDownS::drawover()
{
	...
	DrawImage(g_texture[m_uptex].texname, m_pos[2]-square(), m_pos[3]+g_font[m_font].gheight*rowsshown()-square(), m_pos[2], m_pos[3]+g_font[m_font].gheight*rowsshown(), 0, 1, 1, 0);
